			...
			<Stack className="filter">
							...
							renderValue={(value) => {
								return (
									<Box sx={{ display: 'flex', gap: 1 }}>
										<SvgIcon color="primary" style={{ width: '18px', height: '18px' }}>
											...
											<svg xmlns="http://www.w3.org/2000/svg" width="19" height="18" viewBox="0 0 19 18" fill="none">
												...
												<defs>
													<clipPath id="clip0_7_5305">
														<rect width="18.1518" height="18" fill="white" transform="translate(0.167969)" />
													</clipPath>
												</defs>
											</svg>
										</SvgIcon>
				...
				<Box className="switch-box" sx={{ mt: '40px' }}>
					...
					<div className="switch small">
						<FormControlLabel
							label="Junior"
							control={<Checkbox defaultChecked={false} name="junior" />}
						/>
					</div>
					<div className="switch small">
						<FormControlLabel
							control={<Checkbox defaultChecked={false} name="middle" />}
							label="Middle"
						/>
					</div>
					<div className="switch small">
						<FormControlLabel
							control={<Checkbox defaultChecked={false} name="Senior" />}
							label="Senior"
						/>
					</div>
				</Box>
