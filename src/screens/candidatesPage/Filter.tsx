...
interface FilterProps {
  candidantsInquiry: MembersInquiry;
  setCandidantsInquiry: (value: MembersInquiry) => void;
  setSearchText: (value: string) => void;
}

export default function Filter(props: FilterProps) {
  const { candidantsInquiry, setCandidantsInquiry, setSearchText } = props;
